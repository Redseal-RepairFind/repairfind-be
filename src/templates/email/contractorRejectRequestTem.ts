...
export const adminToContractorAfterDocsValidSendEmailHtmlMailTemplate = (contractofirstName: string, customerName: string) => `
  <html>
    <head>
      <style>
    ...
    <body>
      ...
      <p style="color: #333333;">document validation</p>
        ...
        <p>Dear ${customerName} your job requet has been rejected by ${contractofirstName}</p>
