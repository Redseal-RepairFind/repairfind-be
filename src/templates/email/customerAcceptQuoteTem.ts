...
export const customerAcceptQouteAndPaySendEmailHtmlMailTemplate = (contractorfirstName: string, customerName: string) => `
  <html>
    <head>
      <style>
    ...
    <body>
      ...
      <p style="color: #333333;">document validation</p>
        ...
        <p>Dear ${contractorfirstName} your job quatation has been accepted and payment is available by ${customerName}</p>
