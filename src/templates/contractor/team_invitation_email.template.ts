...
export const NewTeamInvitationEmail = (memberName: string, companyName: string) => `
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="email-wrapper">
        ...
        <div class="content">
            <h2 style="color: #333333;">Team Invitation</h2>
            <p style="color: #666666;">Hello ${memberName},</p>
            <p style="color: #666666;">We want to inform you that you have been invited on RepairFind to join ${companyName} team.</p>
            <p style="color: #666666;">Kindly open the app and accept/decline the invitation</p>
