...
export const htmlJobQuotationAcceptedContractorEmailTemplate = (contractor: string, customer: string, job: any) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <table class="container">
    ...
    <tr>
      <td class="content">
        <p>Dear ${contractor},</p>
        <p>Your job  quotation to  a customer, ${customer},  on RepairFind has been accepted.</p>
