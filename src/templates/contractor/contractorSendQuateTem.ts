...
export const contractorSendJobQuatationSendEmailHtmlMailTemplate = (contractorfirstName: string, customerName: string) => `
  <html>
    <head>
      <style>
    ...
    <body>
      ...
      <p style="color: #333333;">document validation</p>
        ...
        <p>Dear ${customerName} job quatation that you requested for has been sent to you by ${contractorfirstName}</p>
