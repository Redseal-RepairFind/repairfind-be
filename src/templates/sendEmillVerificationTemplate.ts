...
export const htmlMailTemplateFroEmailVerification = (otp: string, firstName: string) => `
  <html>
    <head>
      <style>
    ...
    <body>
      ...
      <p style="color: #333333;">We have received a request to verify your email.</p>
      <p style="color: #333333;">Please use the following OTP to change password:</p>
        <div class="otp">${otp}</div>
        <p>If you did not request this code, please ignore this email.</p>
        <p style="color: #333333;">Thank you for choosing RedSeal Repair.</p>
        <p style="color: #333333;">Best regards,</p>
        <p style="color: #333333;">RedSeal Repair Team</p>
      </div>
    </body>
  </html>
`;