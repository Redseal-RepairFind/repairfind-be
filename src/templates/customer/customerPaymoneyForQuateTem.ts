...
export const customerToAdminAfterPaymentSendEmailHtmlMailTemplate = (contractorfirstName: string, customer: string) => `
  <html>
    <head>
      <style>
    ...
    <body>
      ...
      <p style="color: #333333;">document validation</p>
        ...
        <p>payment has been successfuly made by ${customer} for job quatation send by ${contractorfirstName}</p>
