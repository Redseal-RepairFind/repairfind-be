...
import CustomerJobRequestModel, { ICustomerJobRequestModel, JobRequestStatus } from "../../../database/customer/models/customer_jobrequest.model";
...
export const createJobRequest = async (
    ...
    try {
        ...
        const { contractorId, category, description, location, date, expiry, emergency, media, voiceDescription, time } = req.body;
        ...
        const existingJobRequest = await CustomerJobRequestModel.findOne({
            customer: customerId,
        ...
        const newJob: ICustomerJobRequestModel = new CustomerJobRequestModel({
...
export const getJobRequests = async (req: any, res: Response) => {
    try {
        ...
        const { contractorId, status, startDate, endDate, date } = req.query;
        const customerId = req.customer.id;
