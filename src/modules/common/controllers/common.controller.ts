...
import { sendAPN2Notification, sendAPNNotification, sendNotification, sendSilentNotification } from "../../../services/notifications/apn";
...
export const sendTestNotification = async (
  ...
  try {
    ...
    sendNotification(['5c331b83caea396d9cf1e43545276d70791200840ecf126124853b6387630fe2'], {title: "Title here", body: "Body here", subtitle: "Subtitle here"}, {sound: "ringtone.wav", badge: 3})
