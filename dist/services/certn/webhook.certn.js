    ...
    return __generator(this, function (_a) {
        try {
            ...
            switch (eventType) {
                ...
                default:
                    console.log("Unhandled Certn event type: ".concat(eventType), eventData);
                    break;
            }
        }
        catch (error) {
...
var handleReportFailed = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    var reportId;
    return __generator(this, function (_a) {
        try {
            reportId = payload.report_id;
...
var handleReportRetrieved = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    var reportId;
    return __generator(this, function (_a) {
        try {
            reportId = payload.report_id;
