...
exports.webhook = exports.retrieveApplicant = exports.initiateDemo = exports.initiateCertnInvite = void 0;
var node_fetch_1 = __importDefault(require("node-fetch"));
var config_1 = require("../../config");
var webhook = __importStar(require("./webhook.certn"));
exports.webhook = webhook;
function initiateCertnInvite(data) {
    return __awaiter(this, void 0, void 0, function () {
        var certnToken, options, certn, certnData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error initiating Certn invite:', error_1);
