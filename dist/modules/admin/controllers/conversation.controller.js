                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, conversation.entity.getMyQoutation(conversation.entity.id, adminId_1)];
                                case 2:
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                //@ts-ignore
                _b = conversation.entity;
                return [4 /*yield*/, conversation.entity.getMyQoutation(conversation.entity.id, adminId)];
            case 3:
                //@ts-ignore
                _b.myQuotation = _c.sent();
                _c.label = 4;
