...
//send Email/////////////
var AdminsendEmailsControlleer = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, errors, transporter, mailOptions;
    return __generator(this, function (_b) {
        _a = req.query;
        errors = (0, express_validator_1.validationResult)(req);
        if (!errors.isEmpty()) {
...
exports.AdminsendEmailsControlleer = AdminsendEmailsControlleer;
