...
exports.AdminNotificationController = exports.redAlerts = exports.markAllNotificationsAsRead = exports.markNotificationAsRead = exports.getSingleNotification = exports.getNotifications = void 0;
...
var getNotifications = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, startDate, endDate, read, query, adminId, filter, _b, data, error, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                filter = { $or: [{ user: null }, { user: adminId }], userType: 'admins' };
...
var getSingleNotification = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var notificationId, notification, error_2, stackLines, originatingLine, message;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
...
var markNotificationAsRead = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var notificationId, notification, error_3;
...
var markAllNotificationsAsRead = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var adminId, filter, query, _a, data, error, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                adminId = req.admin.id;
                filter = { user: adminId, userType: 'admins' };
