...
exports.adminGetNotificationrController = adminGetNotificationrController;
//admin view unseen  notification/////////////
var adminViewNotificationrController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, errors, admin, adminId, notifications, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
...
exports.adminViewNotificationrController = adminViewNotificationrController;
//admin get total number of unseen notification/////////////
var adminUnseenNotificationrController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, errors, admin, adminId, totalUnseenNotification, err_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
...
exports.adminUnseenNotificationrController = adminUnseenNotificationrController;
