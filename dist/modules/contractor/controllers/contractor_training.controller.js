...
exports.QuizController = exports.SubmitQuiz = exports.StartQuiz = void 0;
...
var StartQuiz = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var contractorId, randomQuizzes, randomQuiz, randomQuestions, quizSession, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                quizSession = encodeURI("https://contractorapp.netlify.app/training?session=".concat(contractorId + "%" + randomQuiz._id));
...
var SubmitQuiz = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, quizId, response, errors, contractorId, contractor, quiz, questions_1, quizResults, contractorQuiz, result, onboarding, ratings, review, existingReview, totalRatings, totalReviewScore, averageRating, newReview_1, foundIndex, err_1;
