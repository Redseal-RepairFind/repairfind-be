...
router.post("/schedules/toggle-off-duty", contractorRoleCheck_middleware_1.checkContractorRole, contractor_schedule_controller_1.ScheduleController.toggleOffDuty);
...
router.get('/jobs/:jobId/quotations', contractorRoleCheck_middleware_1.checkContractorRole, contractor_job_controller_1.ContractorJobController.getQuotationForJob);
...
router.get("/voicecall/lastcall", contractorRoleCheck_middleware_1.checkContractorRole, contractor_call_controller_1.ContractorCallController.getLastCall);
router.get("/voicecall/:callId", contractorRoleCheck_middleware_1.checkContractorRole, contractor_call_controller_1.ContractorCallController.getSingleCall);
