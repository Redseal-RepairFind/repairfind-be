...
var getNotifications = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, startDate, endDate, read, unread, customerId, filter, features, notifications, limit, page, count, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                features = new api_feature_1.APIFeatures(customer_notification_model_1.default.find(filter), req.query);
            ...
            case 1:
                ...
                return [4 /*yield*/, customer_notification_model_1.default.find(filter).countDocuments()];
            case 2:
                count = _b.sent();
                res.status(200).json({
