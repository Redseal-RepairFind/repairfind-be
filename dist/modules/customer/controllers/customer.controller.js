    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                events_1.AccountEvent.emit('ACCOUNT_UPDATED', { user: updatedCustomer, userType: 'customers' });
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, customer_devices_model_1.default.findOneAndUpdate({ customer: customerId, deviceId: deviceId }, { $set: { deviceToken: deviceToken, deviceType: deviceType, expoToken: expoToken, appVersion: appVersion, customer: customerId, deviceId: deviceId } }, { new: true, upsert: true })];
            case 3:
