    ...
    return __generator(this, function (_m) {
        switch (_m.label) {
            case 0:
                ...
                req.limit = 10;
                return [4 /*yield*/, (0, api_feature_1.applyAPIFeature)(contractor_model_1.ContractorModel.find({ accountType: contractor_interface_1.CONTRACTOR_TYPES.Individual }), req.query)];
            case 1:
